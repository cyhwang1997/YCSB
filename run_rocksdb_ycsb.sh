...
#./bin/ycsb -cp rocksdb_binding/rocksdbjni-test0410.jar load rocksdb -P workloads/workloadcy -p rocksdb.dir=/home/cyhwang/rocksdb_filter_test/ycsb/0410_nooption -p threadcount=8
#./bin/ycsb -cp rocksdb_binding/rocksdbjni-test0410.jar run rocksdb -P workloads/workloadcy -p rocksdb.dir=/home/cyhwang/rocksdb_filter_test/ycsb/0410_nooption -p threadcount=8
